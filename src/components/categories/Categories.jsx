  ...
  return (
    <div className = "container px-5 py-8 md:py-16 mx-auto">
      <div className = "lg:w-1/2 w-full mb-6 lg:mb-10">
        <p className = "text-2xl mb-2 text-black font-rubik">Young's Favourite</p>
      ...
      <div className = "flex flex-wrap font-poppins">
        <div className = "flex flex-col">
          ...
          <p className = "text-md font-medium mb-[1px]">Trending on instagram</p>
        ...
        <div className = "flex flex-col">
          ...
          <p className = "text-md font-medium mb-[1px]">All under 400</p>
